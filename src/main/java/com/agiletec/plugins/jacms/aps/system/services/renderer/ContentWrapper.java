...
/**
 * Rappresenta un contenuto nella forma utilizzabile al servizio di
 * renderizzazione. La classe estende HashMap per un agevole accesso agli
 * attributi che popolano il contenuto.
 *
...
public class ContentWrapper extends EntityWrapper {
     ...
     *
     * @param content Il contenuto da utilizzare dal servizio di
     * renderizzazione.
     */
    ...
    /**
     * Restituisce un URL simbolico che punta al contenuto stesso (link di tipo
     * SymbolicLink.CONTENT_TYPE).
     *
    ...
    /**
     * Restituisce un URL simbolico che punta al contenuto stesso su una pagina
     * specficata (link di tipo SymbolicLink.CONTENT_ON_PAGE_TYPE).
     *
    ...
    // added for Tribunale_marsala - 2019-09-02
    public String getDescription() {
        return super.getEntity().getDescription();
    }
