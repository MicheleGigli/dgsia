...
public abstract class AbstractResourceAttribute extends TextAttribute
    ...
    public ResourceInterface getResource(String langCode) {
        ResourceInterface resource = (ResourceInterface) this.getResources().get(langCode);
        // MODIFICATO PER GIUSTIZIA / ALMAVIVA
        if (null == resource && "it".equals(langCode)) {
            resource = (ResourceInterface) this.getResources().get("en");
        }
        return resource;
    }
