...
public class ContentListTag extends TagSupport implements IContentListTagBean {
    ...
    public int doEndTag() throws JspException {
        ...
        try {
            ...
            if (!StringUtils.isBlank(selectedCategory)) {
                this._categories = ArrayUtils.add(this._categories, selectedCategory);
            }
    ...
    /**
     * Get the name of the variable in the page context that holds the list of
     * the IDs found.
     *
    ...
    /**
     * Set the name of the variable in the page context that holds the list of
     * the IDs found.
     *
    ...
    /**
     * Checks if the list if the list has been previously stored in the startTag
     * method.
     *
    ...
    /**
     * Set if the list if the list has been previously stored in the startTag
     * method.
     *
    ...
    /**
     * Toggles the system caching usage when retrieving the list. Admitted
