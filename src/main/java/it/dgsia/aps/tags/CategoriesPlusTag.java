 ...
 * @author E.Santoboni
 */
public class CategoriesPlusTag extends TagSupport {

    private static final Logger _logger = LoggerFactory.getLogger(CategoriesPlusTag.class);
    ...
    private boolean addSubChildren;
    ...
    public boolean getAddSubChildren() {
        return addSubChildren;
    }

    public void setAddSubChildren(boolean addSubChildren) {
        this.addSubChildren = addSubChildren;
    }
