...
<contenttypes>
	<contenttype typecode="CNG" typedescr="Generic Content" viewpage="paginadettaglio" listmodel="10011" defaultmodel="10001">
		<attributes>
	...
	<contenttype typecode="CON" typedescr="Contenuto composto" viewpage="**NULL**" listmodel="10000" defaultmodel="10000">
		<attributes>
	...
	<contenttype typecode="CTA" typedescr="Contenuto lista" viewpage="paginadettaglio" listmodel="8" defaultmodel="8">
		<attributes>
	...
	<contenttype typecode="CTM" typedescr="Contenuto base titl+sub+img+link" viewpage="**NULL**" listmodel="4" defaultmodel="4">
		<attributes>
	...
	<contenttype typecode="DLD" typedescr="Download Card" viewpage="paginadettaglio" listmodel="10031" defaultmodel="10003">
		<attributes>
			<attribute name="Title" attributetype="Text" searchable="true" indexingtype="TEXT">
				<validations>
					<required>true</required>
	...
	<contenttype typecode="IMG" typedescr="title+img" viewpage="paginadettaglio" listmodel="101" defaultmodel="101">
		<attributes>
	...
	<contenttype typecode="IPT" typedescr="ipertesto" viewpage="paginadettaglio" listmodel="103" defaultmodel="103">
		<attributes>
	...
	<contenttype typecode="NTZ" typedescr="Notizia" viewpage="**NULL**" listmodel="**NULL**" defaultmodel="**NULL**">
		<attributes>
			<list name="Cont_not" attributetype="Monolist" description="Contenuto notizia">
				<validations />
				<nestedtype>
					<attribute name="Cont_not" attributetype="Composite">
						<attributes>
							<attribute name="Desc_not" attributetype="Hypertext" description="Descrizione notizia">
								<validations />
							</attribute>
							<attribute name="img_not" attributetype="Image" description="Img notizia">
								<validations />
							</attribute>
							<attribute name="all_not" attributetype="Attach" description="Allegato notizia">
								<validations />
							</attribute>
							<attribute name="link_not" attributetype="Link" description="Link notizia">
								<validations />
							</attribute>
						</attributes>
					</attribute>
	...
	<contenttype typecode="PRC" typedescr="Procedura" viewpage="**NULL**" listmodel="31" defaultmodel="31">
		<attributes>
			...
			<attribute name="COSE" attributetype="Hypertext" description="COS''È" />
			<attribute name="CHI_PUO_RI" attributetype="Hypertext" description="CHI PUÒ RICHIEDERLO" />
			<attribute name="DOVE_SI_RI" attributetype="Hypertext" description="DOVE SI RICHIEDE" />
			<attribute name="DOC_NECESS" attributetype="Hypertext" description="COME SI RICHIEDE E DOCUMENTI NECESSARI" />
			<attribute name="TEMPI" attributetype="Hypertext" description="TEMPI" />
			<attribute name="COSTI" attributetype="Hypertext" description="COSTI" />
		</attributes>
	</contenttype>
	<contenttype typecode="PRO" typedescr="Contenuto Procedura Concorsuale" viewpage="paginadettaglio" listmodel="10005" defaultmodel="10005">
		<attributes>
	...
	<contenttype typecode="SCH" typedescr="scheda utente all informazioni" viewpage="**NULL**" listmodel="100" defaultmodel="100">
		<attributes>
	...
	<contenttype typecode="STA" typedescr="Contenuto Statistica Lista" viewpage="**NULL**" listmodel="10004" defaultmodel="10004">
		<attributes>
	...
	<contenttype typecode="TIR" typedescr="Contenuto Tirocinio Formativo" viewpage="paginadettaglio" listmodel="10002" defaultmodel="10002">
		<attributes>
...
<reports status="OK">
	<creation>2019-07-30 17:32:01</creation>
	<lastupdate>2019-07-30 17:32:16</lastupdate>
	<components>
		<component code="entandoCore" date="2019-07-30 17:32:01" status="OK">
			<schema status="OK">
		...
		<component code="entando-misc-jquery" date="2019-07-30 17:32:08" status="OK">
			<schema status="OK">
		...
		<component code="entando-misc-html5-essentials" date="2019-07-30 17:32:08" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-misc-bootstrap" date="2019-07-30 17:32:08" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-misc-less" date="2019-07-30 17:32:08" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="jacms" date="2019-07-30 17:32:08" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="OK">
		...
		<component code="entando-content-generic" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-content-download" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-widget-navigation_bar" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-widget-navigation_breadcrumbs" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-admin-console" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="OK">
		...
		<component code="entando-portal-ui" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-app-view-cms-default" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="jpinfinispan" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-widget-language_choose" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-widget-login_form" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-widget-search_form" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="entando-page-bootstrap-hero" date="2019-07-30 17:32:11" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
...
');
INSERT INTO sysconfig (version,item,descr,config) VALUES ('production','subIndexDir','Name of the sub-directory containing content indexing files','indexdir20190720154138');
