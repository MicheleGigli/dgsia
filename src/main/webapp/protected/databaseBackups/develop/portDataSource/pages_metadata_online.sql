...
INSERT INTO pages_metadata_online (code,titles,modelcode,showinmenu,extraconfig,updatedat) VALUES ('second_level_page','<?xml version="1.0" encoding="UTF-8"?>
<properties>
<property key="en">second level page</property>
<property key="it">pagina secondo livello</property>
</properties>

','second-level-page',1,'<?xml version="1.0" encoding="UTF-8"?>
<config>
  <useextratitles>false</useextratitles>
  <charset>utf-8</charset>
  <mimeType>text/html</mimeType>
