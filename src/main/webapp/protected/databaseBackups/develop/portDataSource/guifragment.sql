...
<div class="mt-3 container py-2 text-right">
    <a class="btn btn-outline-primary" href="<@wp.url page="${pageLinkVar}"/>">
      ${pageLinkDescriptionVar}
    </a>
</div>

</#if>','<#assign jacms=JspTaglibs["/jacms-aps-core"]>
<#assign wp=JspTaglibs["/aps-core"]>
...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('lista_moduli','lista_moduli',NULL,'',NULL,0);
