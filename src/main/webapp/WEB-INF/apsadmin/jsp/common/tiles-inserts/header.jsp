...
<div class="navbar-header">
    ...
    <a href="<s:url action="main" namespace="/do" />" class="navbar-brand">
        <img class="navbar-brand-icon logo-entando" src="<wp:resourceURL />administration/img/entando-logo.svg" alt="Entando <wp:info key="systemParam" paramName="version" />" />
    ...
    <ul class="nav navbar-nav navbar-right navbar-iconic">
        <li id="preview-portal" class="drawer-pf-trigger2 notifications dropdown">
           <%--  <a class="nav-item-iconic" target="#" href="<s:url value="/" />" title="<s:text name="note.goToPortal" /> ( <s:text name="note.sameWindow" /> )"> --%>
            <a class="nav-item-iconic" target="blank" href='<wp:url page="homepage" />' title="<s:text name="note.goToPortal" /> ( in un'altra finestra )">
        ...
        <li id="userDropdown" class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
            	<wp:ifauthorized permission="superuser" var="canEditProfile" />
