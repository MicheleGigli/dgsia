                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-6">
                        <a href="<wp:url page="homepage" />" > 
                            <img alt="Tribunale di Marsala" title="Tribunale di Marsala" class="img-fluid" src="<wp:imgURL />logo-Tribunale-di-Marsala.png">
                        </a>
                    </div>
                            ...
                            <div class="header-social text-right">
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <a alt="Facebook" title="Facebook" href="">
                                    ...
                                    <li class="list-inline-item">
                                        <a alt="YouTube" title="YouTube" href="">
                                            <svg class="icon icon-primary">
                ...
                <div class="row">
                    ...
                    <div class="col col-sm-6 col-lg-3 my-3">
                        ...
                        <div>
                            ...
                            <p>
                                <a alt="tribunale.marsala@giustizia.it" title="tribunale.marsala@giustizia.it" href="">tribunale.marsala@giustizia.it</a>
                            </p>
                        </div>
                    </div>
